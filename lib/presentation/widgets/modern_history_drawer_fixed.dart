...
class ModernHistoryDrawer extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      width: MediaQuery.of(context).size.width * (MediaQuery.of(context).size.width > 600 ? 0.7 : 0.85),
              ...
              Column(
                children: [
                  ...
                  ValueListenableBuilder(
                    valueListenable: Hive.box<CalculationModel>('calculations').listenable(),
                  ...
                  Expanded(
                    child: ValueListenableBuilder(
                      valueListenable: Hive.box<CalculationModel>('calculations').listenable(),
                      builder: (context, box, _) {
                        final calculations = box.values.toList().reversed.toList();
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  ...
                                  ref.read(calculatorProvider.notifier).useHistoryItem(
                                    item.expression, 
                                    item.result,
                                  );
                                  Navigator.pop(context);
